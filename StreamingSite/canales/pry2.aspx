<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="pry2.aspx.cs" Inherits="StreamingSite.canales.pry2" %>
...
<asp:Content ID="contenido" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <div class="row">
        <div class="col-xs-12 margin-top-xs">
            <div class="fb-follow" data-href="https://www.facebook.com/Proyecto-20-895-FM-Radio-UAQ-1191938504168883" data-layout="button" data-show-faces="false">
            </div>
            <div class="fb-share-button" data-href="https://www.facebook.com/Proyecto-20-895-FM-Radio-UAQ-1191938504168883" data-layout="button" data-mobile-iframe="true"></div>
            <div class="fb-like" data-href="https://www.facebook.com/Proyecto-20-895-FM-Radio-UAQ-1191938504168883" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
        </div>
    </div>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//radio-uaq.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/pryMf3VbIHZYNwJki4KbWZ0',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/pryMf3VbIHZYNwJki4KbWZ0',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/pryMf3VbIHZYNwJki4KbWZ0.m3u8',
			}
		);
	</script>
</asp:Content>
