<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="ebc.aspx.cs" Inherits="StreamingSite.canales.ebc" %>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//uaqebc.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/ebc5zGcuYI4Y0pcw1oNTbCD',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/ebc5zGcuYI4Y0pcw1oNTbCD',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/ebc5zGcuYI4Y0pcw1oNTbCD.m3u8',
			}
		);
	</script>
</asp:Content>
