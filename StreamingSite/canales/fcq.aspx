<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="fcq.aspx.cs" Inherits="StreamingSite.canales.fcq" %>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//uaqfcq.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fcq7wkXJMsQKMwE47JxB7TF',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fcq7wkXJMsQKMwE47JxB7TF',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/fcq7wkXJMsQKMwE47JxB7TF.m3u8',
			}
		);
	</script>
</asp:Content>
