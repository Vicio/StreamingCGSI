<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="fin.aspx.cs" Inherits="StreamingSite.canales.fin" %>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//uaqfin.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fin3oFh4eJxta8LnhIj5cql',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fin3oFh4eJxta8LnhIj5cql',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/fin3oFh4eJxta8LnhIj5cql.m3u8',
			}
		);
	</script>
</asp:Content>
