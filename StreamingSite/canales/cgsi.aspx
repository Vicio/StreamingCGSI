<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="cgsi.aspx.cs" Inherits="StreamingSite.canales.cgsi" %>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//cgsi.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/cgsirDLERnjt0BNfNfdiw9bb',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/cgsirDLERnjt0BNfNfdiw9bb',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/cgsirDLERnjt0BNfNfdiw9bb.m3u8',
			}
		);
	</script>
</asp:Content>
