<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="tvuaq.aspx.cs" Inherits="StreamingSite.canales.tvuaq" %>

<asp:Content ID="encabezado" ContentPlaceHolderID="encabezado" Runat="Server">
    <link rel="stylesheet" href="../css/theme.tvuaq.min.css" />
    <link rel="stylesheet" href="../css/fixes.tvuaq.css" />
    <script type="text/javascript" src="http://content.jwplatform.com/libraries/TDLQ5lRr.js"></script>
</asp:Content>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//tvuaq.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/tvuaqX82zd7zTDvib6hQmq7Qp',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/tvuaqX82zd7zTDvib6hQmq7Qp',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/tvuaqX82zd7zTDvib6hQmq7Qp.m3u8',
			}
		);
	</script>
</asp:Content>
