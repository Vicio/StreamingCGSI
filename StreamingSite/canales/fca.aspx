<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="fca.aspx.cs" Inherits="StreamingSite.canales.fca" %>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//uaqfca.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fcabFE0hOZTlSKgVsKq4EOe',
	                        label: "720p HD"
	                    },
	                    {
                            file: 'rtmp://148.220.38.241:1935/live/fcabFE0hOZTlSKgVsKq4EOe',
	...
	<script type='text/javascript'>
		...
		(
			{
				file: 'http://148.220.38.241/hls/fcabFE0hOZTlSKgVsKq4EOe.m3u8',
			}
		);
	</script>
</asp:Content>
