<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="fps.aspx.cs" Inherits="StreamingSite.canales.fps" %>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//uaqfps.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fpst8JA2gkSt5MzFcEzyXnH',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fpst8JA2gkSt5MzFcEzyXnH',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/fpst8JA2gkSt5MzFcEzyXnH.m3u8',
			}
		);
	</script>
</asp:Content>
