<%@ Page Title="" Language="C#" MasterPageFile="~/canales/MasterPage.Master" AutoEventWireup="true" CodeBehind="fde.aspx.cs" Inherits="StreamingSite.canales.fde" %>
    ...
    <script>
        ...
        */
        (function() {  // DON'T EDIT BELOW THIS LINE
            ...
            s.src = '//uaqfde.disqus.com/embed.js';
...
<%--    <div class="row margin-bottom-xs">
        ...
        (
            {
	            ...
	            [
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fdaT3racLSmTPLOxlvB7VN',
	                        label: "720p HD"
	                    },
	                    {
	                        file: 'rtmp://148.220.38.241:1935/live/fdaT3racLSmTPLOxlvB7VN',
	...
	<script type='text/javascript'>
		...
		(
			{
			    file: 'http://148.220.38.241/hls/fdaT3racLSmTPLOxlvB7VN.m3u8',
			}
		);
	</script>
</asp:Content>
